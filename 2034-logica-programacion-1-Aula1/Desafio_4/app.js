...
console.log("Bienvenid@ al minijuego")
...
let language = prompt('¿Cuál es el lenguaje de programación que más te gusta?')
console.log(`El lenguaje favorito del usuario es: ${language}`)
